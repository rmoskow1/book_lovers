...
class SerializerTests(TestCase):
    ...
    #def test_user_serializer_password(self):
        ...
        #self.assertTrue(is_password_usable(serializer.data.__getitem__('password'))) #using django's built-in method, check if the password is a properly hashed password
